...
calculator = MACECalculator(model_paths='/u/lazerpo/poRaman/anthra-MACE/anthra_float32_swa.model', device='cuda', default_dtype='float32')
init_conf = read('100-444.xyz', format='extxyz')
